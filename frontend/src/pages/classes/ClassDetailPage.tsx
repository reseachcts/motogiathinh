...
import {
  Button, Col, Descriptions, Input, Progress, Row, Select, Spin, Table, Tag, Typography,
} from 'antd'
...
const LEARN_TAG: Record<string, { color: string; label: string }> = {
...
const VEHICLE_STATUS_LABEL: Record<string, string> = {
  active: 'Hoạt động', maintenance: 'Bảo dưỡng', retired: 'Ngừng sử dụng', inactive: 'Không hoạt động',
}
